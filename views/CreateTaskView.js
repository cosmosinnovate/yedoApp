    ...
    return (
        <View style={{
            ...
            <View style={{
                ...
                <TouchableOpacity>
                    <AppText weight='500' mV={10} size="18" color={colors.appleBlue}>Cancel</AppText>
                </TouchableOpacity>
                <AppText weight='500' mV={10} size="18">Details</AppText>
                <TouchableOpacity>
                    <AppText weight='500' mV={10} size="18" color={colors.appleBlue}>Done</AppText>
                </TouchableOpacity>
            </View>
                ...
                <View style={{
                    ...
                    <View style={{
                        ...
                        <View style={{
                            ...
                            <AppText size={14} color={colors.appleBlue}>Friday,
                                June 4,
                                2020</AppText>
                        </View>
                    ...
                    <View style={{
                        ...
                        <View style={{
                            ...
                            <AppText size={14} color={colors.appleBlue}>2:00 PM</AppText>
                        </View>
                        <View style={{ justifyContent: 'flex-end' }}>
                ...
                <View style={{
                    ...
                    <View style={{
                        ...
                        <View style={{
                            ...
                            <AppText size={14} color={colors.primary}>Repeat</AppText>
                        </View>
                        <View style={{ justifyContent: 'flex-end' }}>
                            <Switch value={isRepeat} onValueChange={newValue => setIsRepeat(newValue)}></Switch>
                        </View>
                    </View>
